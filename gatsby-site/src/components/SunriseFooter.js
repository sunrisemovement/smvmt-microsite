...
const SunriseFooter = ({ hubName, socialMediaMap, donationLink }) => {
  ...
  return (
    <Container>
      {donationLink && (
        <DonationLink>
          <Button label={`Donate to Sunrise ${hubName}`} href={donationLink} />
        </DonationLink>
      )}
